...
describe('the segment object returned by pathCalculator.calculateSegment should contain intermediate calculations and debugging information', () => {
  ...
  it('should contain the vector "d12" between the two obstacle origins', () => {
